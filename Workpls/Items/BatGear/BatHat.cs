...
namespace Workpls.Items.BatGear
{
	...
	{	int Probe = -1;
        ...
        {	
			...
			if (Probe == -1)
			{
					Probe = Projectile.NewProjectile(player.position.X, player.position.Y, 0, 0, mod.ProjectileType("VampireProbe"), 14, 0, player.whoAmI);
					}
		...
		public override void AddRecipes()
		{
			...
			recipe.AddIngredient(null, "GoblinRockBar", 36);
